...
# wallet Gnosis Safe proxy, 3 = POLY_1271 deposit wallet). Defaults to 3
# (POLY_1271 deposit wallet — the verified-working type for live order
# placement). Leave the address unset for a plain EOA wallet signing with
